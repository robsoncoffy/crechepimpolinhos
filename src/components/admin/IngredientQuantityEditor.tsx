...
import { Loader2, Scale, Trash2, RefreshCw, Search, X, Plus, AlertTriangle } from 'lucide-react';
...
import { IngredientWithNutrition, NutritionTotals, ParsedIngredient } from '@/types/nutrition';
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto_auto_auto] items-center gap-2">
                <div className="flex flex-col min-w-0">
                  <span className={`text-xs font-medium truncate ${ingredient.id === -1 ? 'text-amber-600' : ''
